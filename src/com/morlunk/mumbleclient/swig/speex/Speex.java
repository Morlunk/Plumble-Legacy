...
public class Speex implements SpeexConstants {
  ...
  public static int speex_encode(SWIGTYPE_p_void state, float[] in, SWIGTYPE_p_SpeexBits bits) {
    return SpeexJNI.speex_encode(SWIGTYPE_p_void.getCPtr(state), in, SWIGTYPE_p_SpeexBits.getCPtr(bits));
  }

  public static int speex_encode_int(SWIGTYPE_p_void state, short[] in, SWIGTYPE_p_SpeexBits bits) {
    return SpeexJNI.speex_encode_int(SWIGTYPE_p_void.getCPtr(state), in, SWIGTYPE_p_SpeexBits.getCPtr(bits));
  }

  public static int speex_encoder_ctl(SWIGTYPE_p_void state, int request, SWIGTYPE_p_void ptr) {
    return SpeexJNI.speex_encoder_ctl(SWIGTYPE_p_void.getCPtr(state), request, SWIGTYPE_p_void.getCPtr(ptr));
  }
  ...
  public static int speex_decode(SWIGTYPE_p_void state, SWIGTYPE_p_SpeexBits bits, float[] out) {
    return SpeexJNI.speex_decode(SWIGTYPE_p_void.getCPtr(state), SWIGTYPE_p_SpeexBits.getCPtr(bits), out);
  }

  public static int speex_decode_int(SWIGTYPE_p_void state, SWIGTYPE_p_SpeexBits bits, short[] out) {
    return SpeexJNI.speex_decode_int(SWIGTYPE_p_void.getCPtr(state), SWIGTYPE_p_SpeexBits.getCPtr(bits), out);
  }

  public static int speex_decoder_ctl(SWIGTYPE_p_void state, int request, SWIGTYPE_p_void ptr) {
    return SpeexJNI.speex_decoder_ctl(SWIGTYPE_p_void.getCPtr(state), request, SWIGTYPE_p_void.getCPtr(ptr));
  }

  public static int speex_mode_query(SpeexMode mode, int request, SWIGTYPE_p_void ptr) {
    return SpeexJNI.speex_mode_query(SpeexMode.getCPtr(mode), mode, request, SWIGTYPE_p_void.getCPtr(ptr));
  }

  public static int speex_lib_ctl(int request, SWIGTYPE_p_void ptr) {
    return SpeexJNI.speex_lib_ctl(request, SWIGTYPE_p_void.getCPtr(ptr));
  }
